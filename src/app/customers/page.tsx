...
const STATIC_STORIES: CustomerStoryResponse[] = [
  ...
  { id: 6, company: '버킷플레이스(오늘의집)', industry: '유통', title: '버킷플레이스, 데이터 품질진단 솔루션 공급', content: '컨텐츠·커머스·커뮤니티가 유기적으로 결합된 서비스 특성상 빠르게 증가하는 데이터의 명확한 표준 관리와 품질관리가 필요했습니다. DA# DQ_Edition을 도입해 데이터 모델링과 품질진단을 하나의 패키지로 해결하고 개발 생산성과 편의성을 높였습니다.', logoUrl: '', thumbnailUrl: '', createdAt: '2021-11-26' },
  { id: 7, company: 'LG유플러스', industry: '서비스', title: '', content: '', logoUrl: '', thumbnailUrl: '', createdAt: '2026-01-01' },
  { id: 8, company: '카카오뱅크', industry: '금융', title: '', content: '', logoUrl: '', thumbnailUrl: '', createdAt: '2026-01-01' },
];
