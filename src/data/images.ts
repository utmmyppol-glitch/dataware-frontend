...
export const ENCORE_IMAGES = {
  ...
  meta: {
    main: `${ENCORE}/solutions_data3-img1.jpg`,
  ...
  dq: {
    main: `${ENCORE}/solutions_data4-img1.jpg`,
  ...
  ap: {
    main: `${ENCORE}/solutions_data5-img1.jpg`,
  ...
  df: {
    main: `${ENCORE}/solutions_data6-img1.jpg`,
  ...
  ett: {
    main: `${ENCORE}/solutions_data7-img1.jpg`,
  ...
  dp: {
    main: `${ENCORE}/solutions_data10-img1.jpg`,
